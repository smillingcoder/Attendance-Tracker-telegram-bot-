# 📅 Attendance Tracker telegram bot (Python)
...
_🎯 **Purpose:** Built to simplify student attendance tracking using Telegram which is already used by many students for their studies — no extra apps, no ads.
